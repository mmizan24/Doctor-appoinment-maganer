  ...
  return (
    <>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto grid w-full max-w-7xl gap-8 rounded-md bg-slate-950 p-6 text-white sm:p-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {features.map(({ title, icon: Icon }) => (
              <div key={title} className="rounded-md bg-white/10 p-5">
